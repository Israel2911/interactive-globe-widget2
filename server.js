...
// =============================================================
// YOUR BASELINE CODE STARTS HERE (PRESERVED)
// =============================================================
...
async function fetchDataFromBackend() {
  try {
    ...
    const response = await fetch('/api/globe-data'); // Authorization headers removed as they are handled by cookies/session now
...
// MODIFIED: This function now calls the new Wix login redirect
...
// MODIFIED: Startup sequence updated to handle login callback
document.addEventListener('DOMContentLoaded', async () => {
  await handleWixLoginCallback(); // MUST run first to handle redirect
...
// MODIFIED: New logout function to communicate with server
